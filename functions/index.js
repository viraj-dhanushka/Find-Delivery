...
.document("/posts/{userId}/companyPosts/{postId}")
.onCreate(async (snapshot, context) => {
  ...
  .onCreate(async (snapshot, context) => {
    ...
    function sendNotification(androidNotificationToken, activityFeedItem) {
      ...
      switch (activityFeedItem.type) {
        case "comment":
          body = `${activityFeedItem.name} replied: ${
            activityFeedItem.commentData
          }`;
          break;
        case "like":
          body = `${activityFeedItem.name} liked your post`;
          break;
        case "follow":
          body = `${activityFeedItem.name} started following you`;
          break;
        default:
          break;
      }
