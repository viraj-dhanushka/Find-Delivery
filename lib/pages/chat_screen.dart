import 'package:finddelivery/constants.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: header(context, titleText: "Chat with Seller"),
      body: SafeArea(
        child: Column(
                  ...
                  FlatButton(
                    onPressed: () {
                      ...
                      _firestore.collection('messages').add({
                        ...
                        'sender': currentUserWithInfo.name,
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        for (var message in messages) {
          ...
          final currentUser = currentUserWithInfo?.id;
